#!/bin/bash
#SBATCH --job-name=std-moe-30b-a3b-2node
#SBATCH --nodes=2
#SBATCH --ntasks-per-node=1
#SBATCH --gpus-per-node=8
#SBATCH --time=48:00:00
#SBATCH --output=logs/std-moe-30b-a3b-2node-%j.out
#SBATCH --error=logs/std-moe-30b-a3b-2node-%j.err
# =============================================================================
# Standard MoE GPT 30B-A3B: Qwen3-30B-A3B Architecture (Multi-Node)
# =============================================================================
...
# =============================================================================
export MODEL_NAME="std-moe-30b-a3b-2node"

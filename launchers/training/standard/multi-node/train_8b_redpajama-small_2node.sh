#!/bin/bash
#SBATCH --job-name=std-8b-2node
#SBATCH --nodes=2
#SBATCH --ntasks-per-node=1
#SBATCH --gpus-per-node=8
#SBATCH --time=24:00:00
#SBATCH --output=logs/std-8b-2node-%j.out
#SBATCH --error=logs/std-8b-2node-%j.err
# =============================================================================
# Standard Dense GPT 8B: Qwen3-8B Architecture (Multi-Node)
# =============================================================================
...
#   - Standard Euclidean geometry (baseline for Lorentz comparison)
#
# Usage:
...
# =============================================================================
export MODEL_NAME="std-8b-2node"

#!/bin/bash
# =============================================================================
# Standard Dense GPT 4B: Qwen3-4B Architecture (Single Node)
# =============================================================================
...
# Run with Apptainer
# =============================================================================
BASE_SCRIPT="${MEGATRON_DIR}/launchers/training/standard/base/_train_moe_base_apptainer.sh"
bash "${BASE_SCRIPT}"
